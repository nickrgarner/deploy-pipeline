...
var servers = 
[
	{name: "base",url:`http://${ip}:9001/`, status: "#cccccc",  scoreTrend : [0]},
	{name: "compare",url:`http://${ip}:9002/`, status: "#cccccc",  scoreTrend : [0]}
];
...
{
	let score = 4 - (server.cpu / 100) - (server.memoryLoad / 100) - Math.min(1, server.latency / 20) - (server.statusCode !== 200 ? 1 : 0);
